...
export const signAccessToken = (payload) => jwt.sign(payload, ACCESS_SECRET, { expiresIn: '2d' });
export const signRefreshToken = (payload) => jwt.sign(payload, REFRESH_SECRET, { expiresIn: '10d' });
